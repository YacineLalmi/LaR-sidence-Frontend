...
export type UpdateBienState = FormState & Bien & { id?: string };

export async function updateBienAction(initialState: UpdateBienState, formData: FormData): Promise<UpdateBienState> {
  const id = formData.get("id") as string;
  // ...extract all fields as in create...
