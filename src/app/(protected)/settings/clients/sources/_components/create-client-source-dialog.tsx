...
export default function CreateClientSourceDialog() {
  ...
  return (
    <FormDialog
      ...
      isPending={isPending}
      title={translation(TRANSLATIONS_KEYS.SETTINGS.CLIENTS.SOURCES.FORM.ADD)}
      trigger={
        <CustomButton text={translation(TRANSLATIONS_KEYS.SETTINGS.CLIENTS.SOURCES.FORM.BUTTON_TEXT)} Icon={Plus} />
      }
