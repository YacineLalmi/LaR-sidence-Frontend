...
import { OfferType } from "@/schemas/offers/offer-type.schema";
...
export default function UpdateOfferTypeDialog({ offerType }: Props) {
  ...
  return (
    <FormDialog
      ...
      isPending={isPending}
      title={translation(TRANSLATIONS_KEYS.SETTINGS.OFFERS.TYPES.FORM.UPDATE)}
