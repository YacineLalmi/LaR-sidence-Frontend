...
export default function CreateBienStatusDialog({ colors }: Props) {
  ...
  return (
    <FormDialog
      ...
      isPending={isPending}
      title={translation(TRANSLATIONS_KEYS.SETTINGS.BIENS.STATUS.FORM.ADD)}
      trigger={
        <CustomButton text={translation(TRANSLATIONS_KEYS.SETTINGS.BIENS.STATUS.FORM.BUTTON_TEXT)} Icon={Plus} />
      }
