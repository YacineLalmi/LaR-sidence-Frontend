...
const TITLE_MAP: Record<string, string> = {
  type: "Nombre des clients",
  source: "Nombre des clients",
  civility: "Nombre des clients",
  status: "Nombre des clients",
  creation: "Nombre des clients",
};

const DESCRIPTION_MAP: Record<string, string> = {
  type: "Typologie des clients",
  source: "Origine des clients",
  creation: "Date de création",
  status: "État des clients",
  civility: "Civilité",
};
...
export function ClientStatsChart() {
  ...
  const filters: ClientFilterStatsForm = React.useMemo(
    () => ({
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const response = await getClientStatsActions(currentGroupBy, filters);
        if (response) {
          setData(response);
        }
      } catch (error) {
