...
import { DemandFilterStatsForm, DemandFilterStatsFormSchema } from "@/schemas/demands/demand-filter-stats-form.schema";
...
export function FilterPanel() {
  ...
  const [wilayas, isWilayasLoading] = useFetch<ListItem[]>(getWilayaListAction, []);

  const [isFiltering, startFilteringTransition] = useTransition();

  const form = useForm<DemandFilterStatsForm>({
    resolver: zodResolver(DemandFilterStatsFormSchema),
    defaultValues: {
  ...
  async function onSubmit(values: DemandFilterStatsForm) {
