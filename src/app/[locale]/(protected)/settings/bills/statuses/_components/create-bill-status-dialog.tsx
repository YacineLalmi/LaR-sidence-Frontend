...
export default function CreateBillStatusDialog() {
  return (
    <CreateClassificationDialog
      category={CATEGORIES.STATUS}
      scope={SCOPES.BILL}
      title={TRANSLATIONS_KEYS_2.SETTINGS.BILLS.STATUSES.FORM.TITLES.CREATE}
      buttonText={TRANSLATIONS_KEYS_2.SETTINGS.BILLS.STATUSES.FORM.BUTTONS.CREATE}
