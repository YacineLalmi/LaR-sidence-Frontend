...
const END_POINTS = {
  create: "/configurations/demands/sources",
  findAll: "/configurations/demands/sources",
  list: "/lists/demands/sources",
  findOne: (id: string) => `/configurations/demands/sources/${id}`,
  update: (id: number) => `/configurations/demands/sources/${id}`,
  delete: (id: number) => `/configurations/demands/sources/${id}`,
};

export const DemandSourceService = {
